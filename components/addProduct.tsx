...
export const AddProduct = () => {
    ...
    const handleSubmit = async (event: React.FormEvent) => {
        ...
        const adminId = '66542da6f1f73b11f47b728a'
    ...
    return (
        <>
                ...
                <div className="lg:col-span-7">
                    ...
                    <Card className='py-4 border-none bg-gray-50'>
                        <CardContent>
                            ...
                            {errors.name && <p className="text-red-500 text-xs mt-1">{errors.category}</p>}
                        </CardContent>
                    </Card>
                            ...
                            <div className="border-2 border-dashed border-gray-400 p-4 bg-white">
                                <div className="grid grid-cols-2 gap-4 mb-4">
                                    {(['mainImage', 'firstImage', 'secondImage', 'thirdImage'] as const).map((field) => (
                                        <div key={field} className="relative aspect-square border border-gray-300 bg-gray-50 flex justify-center items-center">
                                            {formData[field] && (
                                                <img
            ...
            <div className='flex justify-center items-center gap-4'>
                ...
                <Button type="submit" onClick={triggerSubmit} className='rounded-none w-40 bg-[#3B9BCE] text-xs md:text-base'>
                    {isLoading
                        ?
                        'Adding...'
                        :
