                        ...
                        <TableBody>
                            {displayedProducts.map((product) => (
                                <TableRow key={product.id}>
                                    ...
                                    <TableCell className="text-xs md:text-base">{product.price.toLocaleString()}</TableCell>
                                    <TableCell className="flex justify-center items-center gap-2">
                                        <div className="flex items-center border pr-2 rounded-md h-10">
                                            ...
                                            md:w-20
                                             border-none h-9 pr-0 text-xs md:text-base">
                                    ...
                                    <TableCell>
                                        <DropdownMenu>
                                            ...
                                            <DropdownMenuContent className="border bg-white shadow rounded">
                                                <DropdownMenuItem className="px-6 hover:bg-black hover:text-white py-2 cursor-pointer text-center border-b" >
                                                    <Link href={`/dashboard/edit-product/${product.id}`} className="">Edit</Link>
                                                </DropdownMenuItem>


                                                <DropdownMenuItem className="px-6 hover:bg-black hover:text-white py-2 cursor-pointer text-center border-b" onClick={()=>{handleDelete(product.id)}}>
                                                    Delete
                                                </DropdownMenuItem>
                                                
                                                <DropdownMenuItem className="px-6 hover:bg-black hover:text-white py-2 cursor-pointer text-center border-b" >
                                                    <Link href={`/dashboard/inventory/layer-with/${product.id}`}>Layer With</Link>
                                                </DropdownMenuItem>
                                                
                                                <DropdownMenuItem className="px-6 hover:bg-black hover:text-white py-2 cursor-pointer text-center border-b font-bold " >
                                                    <Link href={`/dashboard/fbt/${product.id}`}>FBT</Link>
                                                </DropdownMenuItem>
                                            </DropdownMenuContent>
                                        </DropdownMenu>
