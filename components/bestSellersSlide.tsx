...
//     pictureArray.push(findProduct.mainImageOriginalName);
//     await deleteImages(pictureArray);
//     const result = await uploadImageToStorage(fileBuffer, '/products' + file.originalName)
// }
